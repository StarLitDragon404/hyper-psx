...
use crate::cpu::register::{Cop0Register, Register};
...
impl Instruction {
    ...
    /// <https://cgi.cse.unsw.edu.au/~cs3231/doc/R3000.pdf#page=214>
    #[inline(always)]
    pub(super) fn rs(&self) -> Register {
        let value = ((self.0 >> 21) & 0x1f) as u8;
        value.into()
    }
    ...
    /// <https://cgi.cse.unsw.edu.au/~cs3231/doc/R3000.pdf#page=214>
    #[inline(always)]
    pub(super) fn rt(&self) -> Register {
        let value = ((self.0 >> 16) & 0x1f) as u8;
        value.into()
    }
    ...
    /// <https://cgi.cse.unsw.edu.au/~cs3231/doc/R3000.pdf#page=214>
    #[inline(always)]
    pub(super) fn rd(&self) -> Register {
        let value = ((self.0 >> 11) & 0x1f) as u8;
        value.into()
    }
    ...
    /// <https://cgi.cse.unsw.edu.au/~cs3231/doc/R3000.pdf#page=214>
    #[inline(always)]
    pub(super) fn cop_rd(&self) -> Cop0Register {
        let value = ((self.0 >> 11) & 0x1f) as u8;
        value.into()
    }
}
